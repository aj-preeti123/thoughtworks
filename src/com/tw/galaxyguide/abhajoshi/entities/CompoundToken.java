...
/**
 * CompoundToken is comprised of multiple tokens from say a compound statement
 * or query. like glob glob Silver is 34 Credits
 * 
 * Name = Silver tokens = two simple tokens credits = 34
 * 
 * @author abha
 *
 */
